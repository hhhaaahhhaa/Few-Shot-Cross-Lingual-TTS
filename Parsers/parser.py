...
#         self.mel = Feature(
#             SFQueryParser(f"{self.root}/mel"), NumpyIO())
#         self.pitch = Feature(
#             SFQueryParser(f"{self.root}/pitch"), NumpyIO(), enable_cache=True)
#         self.interpolate_pitch = Feature(
#             SFQueryParser(f"{self.root}/interpolate_pitch"), NumpyIO(), enable_cache=True)
#         self.energy = Feature(
#             SFQueryParser(f"{self.root}/energy"), NumpyIO(), enable_cache=True)
#         self.mfa_duration_avg_pitch = Feature(
#             SFQueryParser(f"{self.root}/mfa_duration_avg_pitch"), NumpyIO(), enable_cache=True)
#         self.mfa_duration_avg_energy = Feature(
#             SFQueryParser(f"{self.root}/mfa_duration_avg_energy"), NumpyIO(), enable_cache=True)
#         self.wav_trim_22050 = Feature(
#             SFQueryParser(f"{self.root}/wav_trim_22050"), NumpyIO())
#         self.wav_trim_16000 = Feature(
#             SFQueryParser(f"{self.root}/wav_trim_16000"), NumpyIO())
#         self.mfa_segment = Feature(
#             SFQueryParser(f"{self.root}/mfa_segment"), PickleIO(), enable_cache=True)
...
#             SFQueryParser(f"{self.root}/spk_ref_mel_slices"), NumpyIO())
#         self.mfa_duration = Feature(
#             SFQueryParser(f"{self.root}/mfa_duration"), NumpyIO(), enable_cache=True)
