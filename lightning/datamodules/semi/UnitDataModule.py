...
import Define
from lightning.collates import SemiCollate
from lightning.datasets.semi import UnitPseudoScoreDataset
...
class UnitDataModule(pl.LightningDataModule):
    ...
    def __init__(self, data_configs, model_config, train_config, algorithm_config, log_dir, result_dir):
        ...
        self.collate = SemiCollate(data_configs)
