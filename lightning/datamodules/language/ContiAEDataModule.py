...
import Define
from lightning.datasets.language import ContiAEDataset
from ..utils import EpisodicInfiniteWrapper
from lightning.collates import GeneralFSCLCollate


class ContiAEDataModule(pl.LightningDataModule):
    """
    Train: ContiAEDataset + GeneralFSCLCollate (unsup).
    Val: ContiAEDataset + GeneralFSCLCollate (unsup).
    Test: None
    """
