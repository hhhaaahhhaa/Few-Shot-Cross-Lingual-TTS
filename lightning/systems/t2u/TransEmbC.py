...
class TransEmbCSystem(AdaptorSystem):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        # visualization
        if batch_idx < 4:
            # symbol_id = qry_batch[9][0]  # all batch belongs to the same language
            # self.saver.log_codebook_attention(self.logger, attn, symbol_id, batch_idx, self.global_step + 1, "val")
            if batch_idx == 0:
